...
<c:forEach items="${pb.beanList }" var="book">
 <li>
  <div class="inner">
	...
	<p><a id="bookname" title="${book.bname }" href="<c:url value='/admin/AdminBookServlet?method=load&amp;bid=${book.bid }'/>">${book.bname }</a><a href="${authorUrl }" name="P_zz" title="${book.author }"><br></a></p>
